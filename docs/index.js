...
'social','memori','trump','mask','kong+hong','plan','coronavirus+trump+biden','death','georg','coronavirus','biden','test','mail+vote','twitter','covid','vote+mail','lost','year','floyd','fact','hous','polic','protest','face','home','pandem','american','summer','check','china','nurs+home','hong+kong','tweet','case','order','reopen'
]
