...
const SARIMAXtopics = [
'watch','china','minneapoli','check','summer','offic','amid','american','reopen','make','time','presid','rioter','store','case','order','hong+kong','tweet','nurs+home','floyd','hous','fact','year','lost','home','pandem','know','penc','citi','face','black','protest','virus','use','polic','floyd+georg','floyd+georg+death','mail+vote','test','carolina','riot','coronavirus','biden','nation','weekend','vote+mail','twitter','covid','antifa','america','death+floyd+georg','georg+floyd+death','honor','death','georg','kong+hong','plan','mask','white','coronavirus+trump+biden','trump','twitter+trump','florida','live','social','memori','mayor'
]
const CORRELATIONtopics = [
'georg+floyd+death','death+floyd+georg','social','memori','live','mayor','twitter+trump','trump','mask','kong+hong','plan','coronavirus+trump+biden','white','death','georg','riot','carolina','coronavirus','biden','test','floyd+georg','mail+vote','floyd+georg+death','antifa','america','twitter','covid','vote+mail','lost','year','biden+trump+twitter','floyd','fact','hous','use','polic','protest','black','face','citi','home','penc','pandem','amid','american','offic','floyd+death+georg','summer','check','china','minneapoli','watch','nurs+home','hong+kong','tweet','store','case','order','rioter','reopen','time','presid'
]
